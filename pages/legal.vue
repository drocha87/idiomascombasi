<template>
  <section>
    <ContainerRow class="px-2 mx-auto mt-12">
      <p class="py-8 text-4xl font-bold text-center font-antonio">
        Privacy Policy
      </p>
      <p class="px-8 tracking-wide text-gray-800 md:px-0 font-redhat">
        This privacy policy (“Policy”) describes how Idiomas com Basi collects,
        protects and uses the personally identifiable information (“Personal
        Information”) you (“User”, “you” or “your”) may provide on the website
      ...
      <p class="py-8 mt-12 text-4xl font-bold text-center font-antonio">
        Collection of personal information
      </p>
      <p class="px-8 tracking-wide text-gray-800 md:px-0 font-redhat">
        We receive and store any information you knowingly provide to us when
        you create an account, publish content, make a purchase, fill any online
        forms on the Website. When required this information may include your
        ...
        but then you may not be able to take advantage of some of the Website’s
      ...
      <p class="px-8 tracking-wide text-gray-800 md:px-0 font-redhat">
        ...
        updates, etc; run and operate our Website and Services. Non-Personal
        Information collected is used only to identify potential cases of abuse
        and establish statistical information regarding Website usage. This
        statistical information is not otherwise aggregated in such a way that
        would identify any particular user of the system.
      </p>
      <p class="px-8 mt-4 tracking-wide text-gray-800 md:px-0 font-redhat">
      ...
      <p class="px-8 tracking-wide text-gray-800 md:px-0 font-redhat">
        ...
        your purchase transaction information is deleted. Where necessary for
        processing future payments and subject to your prior consent, your
        financial information will be stored in encrypted form on secure servers
        of our reputed payment gateway service provider who is beholden to
        treating your Personal Information in accordance with this Privacy
        Policy. All direct payment gateways adhere to the latest security
        standards as managed by the PCI Security Standards Council, which is a
        joint effort of brands like Visa, MasterCard, American Express and
        Discover. Sensitive and private data exchange happens over a SSL secured
        communication channel and is encrypted and protected with digital
        signatures, and our Website is also in compliance with PCI vulnerability
        standards in order to create as secure of an environment as possible for
        Users.
      </p>
      ...
      <p class="px-8 tracking-wide text-gray-800 md:px-0 font-redhat">
        ...
        use cookies to collect, store, and track information for statistical
        purposes to operate our Website and Services. You have the ability to
        ...
        cookies if you prefer. If you choose to decline cookies, you may not be
        able to fully experience the features of the Website and Services. To
      ...
      <p class="px-8 mt-8 tracking-wide text-gray-800 md:px-0 font-redhat">
        This document was last updated on May 07, 2021
      </p>
    </ContainerRow>
  </section>
</template>
